<x-app-layout title="{{ $project->hostname }} {{ __('ranking-factor.keywords-not-present') }}">
    <div id="mainContent" class="container">
        <x-header title="{{ __('ranking-factor.keywords-not-present') }}" :project="$project"></x-header>

            <div class="row mt-4">
                <div class="col">

                    <div class="mb-3 bg-info-light p-3 rounded-2 mb-5 border">
                    ...
                    <div v-cloak>
                        ...
                        <dataset-filters
                            ...
                            v-slot="{ filters }"
                        >
                            @includeIf('partials.filters.DropdownFilter', ['property' => 'competitors', 'options' => $competitorsBenchmarked, 'multiple' => 'true', 'taggable' => 'true'])
                        ...
                        <dataset
                            api="{{ route('api.v1.ranking-factors.keywords-not-present', ['project' => $project]) }}"
